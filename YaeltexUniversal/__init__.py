...
def get_capabilities():
	return {CONTROLLER_ID_KEY: controller_id(vendor_id=2536, product_ids=[115], model_name='YaeltexUniversal'),
...
def create_instance(c_instance):
	""" Creates and returns the YaeltexUniversal script """
	return YaeltexUniversal(c_instance)
