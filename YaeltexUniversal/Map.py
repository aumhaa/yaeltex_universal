...
TRACK_PARAMETER_ON_OFF_NOTES = list(range(64))
TRACK_PARAMETER_ON_OFF_CHANNEL = 3

TRACK1_PARAMETER_CCS = list(range(0, 48))
TRACK1_PARAMETER_CHANNEL = 2

TRACK2_PARAMETER_CCS = list(range(0, 48))
TRACK2_PARAMETER_CHANNEL = 3

TRACK3_PARAMETER_CCS = list(range(0, 48))
TRACK3_PARAMETER_CHANNEL = 4

TRACK4_PARAMETER_CCS = list(range(0, 48))
TRACK4_PARAMETER_CHANNEL = 5

TRACK5_PARAMETER_CCS = list(range(0, 48))
TRACK5_PARAMETER_CHANNEL = 6

TRACK6_PARAMETER_CCS = list(range(0, 48))
TRACK6_PARAMETER_CHANNEL = 7

TRACK7_PARAMETER_CCS = list(range(0, 48))
TRACK7_PARAMETER_CHANNEL = 8

TRACK8_PARAMETER_CCS = list(range(0, 48))
