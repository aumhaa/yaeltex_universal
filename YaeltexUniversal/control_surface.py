...
# from aumhaa.v3.control_surface.elements import MonoButtonElement, MonoBridgeElement
from .utilities import LividSettings
...
class YaeltexControlSurface(ControlSurface):
	...
	def __init__(self, *a, **k):
		...
		with self.component_guard():
			...
			self._yaeltex_settings = LividSettings(model = self._sysex_id, control_surface = self)
